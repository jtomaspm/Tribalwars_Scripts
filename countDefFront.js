...
var minTroop = 0; // tropas minimas na aldeia de uma das unidades lentas
...
var horasMax = 5; //Minimo numero de horas da linha da front
...
$.getAll(URLs,
    ...
    newWin.document.write('Tropas de '+$('select.input-nicer')[0][i+1].text + '<br>')
    countL = 0;
    countE = 0;
    countA = 0;
    ...
    if (((!minDistance[1]==blue & (minDistance[0] < maxDistanceToFront)) || minDistance[1]==blue)  & (Math.max(parseInt(lancas.innerHTML),parseInt(espadas.innerHTML),parseInt(arcos.innerHTML)) > minTroop)){
